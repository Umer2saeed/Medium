<div class="my-12 hover:shadow-2xl transition duration-300 ease-in-out rounded-xl p-4">
    ...
    <div class="my-2">
        <div class="flex flex-row bg-white justify-between">
            <div class="flex flex-col flex-wrap px-4">
                ...
                <div class="flex mt-4 gap-4">
                    <div class="text-sm text-gray-500 flex flex-col justify-center">
                        <span class="post_published_date">Apr 24</span>
                    </div>

                    <div class="post_likes text-sm text-gray-500 flex flex-col justify-center gap-1">
                    ...
                    <div class="post_comments text-sm text-gray-500 flex flex-col justify-center gap-1">
                        <div class="inline-flex items-center gap-1">
                            <span>
                    ...
                    <div class="post_save text-sm text-gray-500 flex flex-col justify-center gap-1">
                        <span>
                           <a href="#">
                             <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 25 25" class="text-gray-500 hover:text-gray-700 inline-block"><path fill="currentColor" d="M18 2.5a.5.5 0 0 1 1 0V5h2.5a.5.5 0 0 1 0 1H19v2.5a.5.5 0 1 1-1 0V6h-2.5a.5.5 0 0 1 0-1H18zM7 7a1 1 0 0 1 1-1h3.5a.5.5 0 0 0 0-1H8a2 2 0 0 0-2 2v14a.5.5 0 0 0 .805.396L12.5 17l5.695 4.396A.5.5 0 0 0 19 21v-8.5a.5.5 0 0 0-1 0v7.485l-5.195-4.012a.5.5 0 0 0-.61 0L7 19.985z"></path></svg>
                           </a>
                        </span>
                    </div>
                </div>
