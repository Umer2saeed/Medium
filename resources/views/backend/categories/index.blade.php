                                ...
                                <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        @if(!empty($category->image))
                                            <img src="{{ asset('storage/'.$category->image) }}" alt="{{ $category->name }}" class="h-16 w-auto rounded-md">
                                        @else
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span class="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-green-600/20 ring-inset">Inactive</span>
                                        @endif
                                    </td>
